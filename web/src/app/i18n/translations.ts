...
export const dictionaries: Record<Locale, Dictionary> = {
  en: {
    ...
    landingHeroTitle: 'Grow smarter with Famer',
    ...
    landingFooter: '© 2026 Famer — built for farmers, with farmers.',
    ...
    feedbackSubtitle: 'Help us improve Famer. Tell us what worked, what broke, and what you would like next.',
    ...
    reportsSubtitle: 'A quick look at how Famer is working for you.',
  ...
  so: {
    ...
    landingHeroTitle: 'Ku kor wax badan oo ku saabsan Famer',
    ...
    landingFooter: '© 2026 Famer — loo dhisay beerayaasha, la beerayaasha.',
    landingSignIn: 'Gali',
    ...
    feedbackSubtitle: 'Naga caawi horumarinta Famer. Noo sheeg waxa shaqeeyay, waxa jabay, iyo waxa aad rabto.',
    ...
    reportsSubtitle: 'Arag sida Famer kuugu shaqaynayo.',
  ...
  ar: {
    ...
    landingHeroTitle: 'انمُ بشكل أذكى مع Famer',
    ...
    landingFooter: '© 2026 Famer — بُني للمزارعين، مع المزارعين.',
    ...
    feedbackSubtitle: 'ساعدنا في تحسين Famer. أخبرنا بما نجح وما تعطل وما تريده لاحقًا.',
    ...
    reportsSubtitle: 'نظرة سريعة على كيفية عمل Famer من أجلك.',
